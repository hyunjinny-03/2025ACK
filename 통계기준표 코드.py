...
# 2. 연령, 성별, 구별(cty_rgn_no), 업종(card_tpbuz_nm_1)별 소비금액 합산
group_cols = ['cty_rgn_no', 'age', 'sex']
grouped = df_all.groupby(group_cols + ['card_tpbuz_nm_1'], as_index=False)['amt'].sum()
...
# 5. 저장
top5.to_csv('card_stats_list.csv', index=False, encoding='utf-8-sig')
